...
The Kubeflow command-line tool, [`kfctl`](https://www.kubeflow.org/docs/gke/deploy/deploy-cli/), can be installed running a few steps. As of January, 2020, because of an error in the kubeflow, we have to make a few extra steps.
